...
SELECT setval(pg_get_serial_sequence('auth','id'), coalesce(max(id), 1)) from auth;
SELECT setval(pg_get_serial_sequence('favourite','id'), coalesce(max(id), 1)) from favourite;
SELECT setval(pg_get_serial_sequence('favourite_group','id'), coalesce(max(id), 1)) from favourite_group;
SELECT setval(pg_get_serial_sequence('node','id'), coalesce(max(id), 1)) from node;
SELECT setval(pg_get_serial_sequence('queue','id'), coalesce(max(id), 1)) from queue;
...
SELECT setval(pg_get_serial_sequence('tag_group','id'), coalesce(max(id), 1)) from tag_group;
SELECT setval(pg_get_serial_sequence('user','id'), coalesce(max(id), 1)) from "user";
SELECT setval(pg_get_serial_sequence('user_group','id'), coalesce(max(id), 1)) from user_group;
